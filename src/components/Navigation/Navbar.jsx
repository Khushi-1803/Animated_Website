...
const Navbar = () => {
  return (
    <div className="fixed top-0 z-40 flex w-full items-start justify-between">
      ...
      <div className="group relative h-12 w-[220px] overflow-hidden cursor-pointer">
  {/* Black Default State */}
  <div className="absolute inset-0 bg-black">
    <div className="absolute right-8 top-7 h-[2px] w-16 bg-white"></div>
    <div className="absolute right-8 top-10 h-[2px] w-10 bg-white"></div>
  </div>

  {/* Green Hover Layer */}
  <div className="absolute inset-0 translate-y-[-100%] bg-lime-300 transition-transform duration-500 ease-in-out group-hover:translate-y-0">
    {/* Same lines, but black */}
    <div className="absolute right-8 top-7 h-[2px] w-16 bg-black"></div>
    <div className="absolute right-8 top-10 h-[2px] w-10 bg-black"></div>
  </div>
</div>
    </div>
  );
